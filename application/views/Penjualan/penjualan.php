                        ...
                        <div id="pos">
                            <div class="well well-sm" id="leftdiv">
                                    ...
                                    <div class="form-group" style="margin-bottom:5px;">
                                        <form>
                                            <div class="form-group">
                                                <input class="form-control" name="idbarang" type="text"
                                                    onkeyup="showResult(this.value)" placeholder="Search...">
                                        ...
                                        <table class="table table-striped list-table" style="margin:0;">
                                            <thead>
                                                <tr class="info">
                                                    ...
                                                    <th style="width: 20px;" class="satu absorbing-column"><i
                                                ...
                                                <div class="card card-body bg-light">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="right">
                                                                Rp.<?= $this->fungsi->rupiah($items['price']); ?></td>
                                                            <td style="text-align:center;">
                                                                <form action="<?= base_url('index.php/ubah_qty'); ?>"
                                                                    method="POST">
                                                                    <input type="hidden" id="idbrg" name="idbarang"
                                                                        value="<?= $items['id_barang']; ?>">
                                                                    <input type="hidden" name="rowid"
                                                                        value="<?= $items['rowid']; ?>">
                                                                    <input type="number" class="total" max="500" min="0"
                                                                        value="<?= $items['qty']; ?>" name="qty"
                                                                        size="5">
                                                                    <button class="btn btn-primary btn-sm fa fa-check"
                                                            ...
                                                            <td align="center">
                                                                <a onclick="location.href = '<?= base_url(); ?>index.php/hapus_cart/<?= $items['rowid']; ?>';"
                                                                    title="Batalkan">
                                ...
                                <table id="totaltbl" class="table table-condensed totals" style="margin-bottom:10px;">
                                    <tr class="info">
                                        <td width="22%">Total Barang</td>
                                        <td width="25%" class="text-center" style="padding-right:10px;">
                                            <span id="count"><?= $this->cart->total_items(); ?></span>
                                        </td>
                                        ...
                                        <td class="text-center" style="font-weight:bold;" colspan="2">
                                            <span id="total">
                                                <span id="count">Rp.<?= $this->fungsi->rupiah($this->cart->total()); ?>
                                                    <input readonly type="hidden" name="total" id="total" onfocus="
                                                        startCalculate()" onblur="stopCalc()"
                                                        value="<?= $this->cart->total(); ?>" required="">
                                                </span></span>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <div class="row">
                                    <div class="col-xs-6" style="padding: 0;">
                                        <div class="btn-group-vertical btn-block">
                                            <a href="<?php echo base_url() ?>index.php/cancel"
                                                class="btn btn-danger btn-block btn-flat" id="reset">Cancel</a>
                                        </div>
                                    </div>
                                    <div class="col-xs-6" style="padding: 0;">
                                        <a href="#" onclick="payment()" class="btn btn-success btn-block btn-flat"
            ...
            <div class="box box-info ">
                <div class="box-header with-border">
                    ...
                    <div class="cold-md-3 push-1">
                        <a href="#" onclick="sort()"
                            class="btn btn-default btn-sm toggle_form pull-right">Tampilkan/Sembunyikan Filter</a>
                    </div>
                    <div class="box-tools pull-right">
                    ...
                    <div class="box-body" style="height:600px;overflow-y: scroll;">
                        <div class="listitem with-border">
                            ...
                            <table id="myTable" class='table table-striped'>
                                <thead class="text-dark bg-gradient" style="background: #3A405A;">
                                    <tr>
                                        <th>No</th>
                                        <th>Nama Produk</th>
                                        <th>Ukuran</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($result as $row) :
                                        ...
                                        // Cek jika stok lebih dari atau sama dengan 1
                                        if ($row->stok_barang >= 1) :
                                    ?>
                                    <tr>
                                        <td>&ensp; <?php echo $no++; ?></td>
                                        <td>&ensp;<?php echo $row->nama_barang; ?></td>
                                        <td>&ensp;<?php echo $row->nama_ukuran; ?></td>
                                        <td>&ensp;<?php echo $row->stok_barang; ?> pcs</td>
                                        <td>&ensp;Rp. <?= $this->fungsi->rupiah($row->harga); ?></td>
                                        <td>
                                            <a href="<?php echo base_url() . 'index.php/penjualan/tambah_barang/' . $add . '/1' ?>"
                                                type="button" class="btn btn-success fa fa-shopping-cart"> Add</a>
                                        </td>
                                    </tr>
                                    <?php
                                        endif;
        ...
        <div class="modal-content">
            <div id="datapayment">
                ...
                <div class="modal-body">
                    <form onSubmit="if(!confirm('Pastikan sudah terjadi pembayaran!')){return false;}"
                        action="<?= base_url('index.php/penjualan/transaksi'); ?>" method="POST" name="frm_byr">
                        <div class="row">
                            <div class="col-xs-12">
                                <div>
                                    <table id="modaltab" class="table table-bordered table-condensed"
                                        style="margin-bottom: 0;">
                                        <tr class="table-secondary">
                                            <td id="mdl" width="25%" style="border-right-color: #FFF !important;">Total
                                                Barang</td>
                                            <td id="mdl" width="25%" class="text-center">
                                                <span id="item_count"><?= $this->cart->total_items(); ?></span>
                                            </td>
                                            <td id="mdl" width="25%" style="border-right-color: #FFF !important;">Grand
                                                Total</td>
                                            <td id="mdl" class="text-right">
                                                <input type="hidden" name="totalpure" id="totalpure"
                                                    value="<?php echo  $this->cart->total(); ?>"
                                                    class="form-control kb-text">
                                                <span>Rp.<input readonly type="number" id="total" name="grandtotal"
                                        ...
                                        <tr>
                                            ...
                                            <td id="mdl" class="text-center"><span>
                                                    <input type="number" name="diskon" id="diskon" max="100" min="0"
                                                        onfocus="startCalculate()" onblur="stopCalc()" value="0"
                                                        required=""><span>%</span>
                                                </span></td>
                                            <td id="mdl" style="border-right-color: #FFF !important;">Kembalian</td>
                                            <td id="mdl" class="text-right">
                                                <span>Rp.
                                                    <input readonly type="number" id="kembalian" name="kembalian"
                                                        onfocus="startCalculate()" onblur="stopCalc()" required="">
                                                </span>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <select class="choices form-select cust" name="pelanggan"
                                                id="datalistOptions-cust" required>
                                                <?php foreach ($cust as $cst) : ?>
                                                <option data-value="<?php echo $cst->id_pelanggan ?>">
                                                    <?php echo $cst->nama_pelanggan ?></option>
                                                <?php endforeach ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" placeholder="Pembayaran" name="bayar"
                                                class="form-control" id="bayar" onfocus="startCalculate()"
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="note" placeholder="Catatan untuk transaksi" id="note"
                                    ...
                                    <div class="col-xs-7">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="norek" name="norek" class="form-control"
                                                data-error="No rekening harus diisi" placeholder="Ex: xxxxxxxxxxxx">
                                        </div>
                                    </div>
                                    <div class="col-xs-5">
                                        <div class="form-group">
