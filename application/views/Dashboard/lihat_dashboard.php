        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-widget widget-user">
                    <div class="widget-user-header " style="background-color: darkgray;">
                        <p style="text-align: center;">
                            <span style="font-family: georgia, palatino; font-size: 15pt;">Selamat datang di SevenINC.</span>
                        </p>
                        <h3 class="widget-user-username"></h3>
                        <h5 class="widget-user-desc"></h5>
                    </div>
                    <div class="widget-user-image">
                        <img class="img" src="<?php echo base_url(); ?>uploads/seveninc.png">
                    </div>
                    <div class="box-footer">
                        <div class="row">
                            ...
                            <div class="col-sm-4 border-right">
                                <div class="description-block">
                                    <h5 class="description-header">Kantor: Jl. Raya Janti, Gang Arjuna No. 59, Karangjambe, Banguntapan, Bantul, Yogyakarta 55198</h5>
                                    </br>
                                    <span class="description-text">No.Telp:0896-3304-0200</span>
                                </div>
                                <center>
